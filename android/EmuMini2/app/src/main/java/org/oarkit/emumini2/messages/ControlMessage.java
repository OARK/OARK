...
public class ControlMessage extends Message {
    ...
    public ControlMessage() {
        ...
        // Control messages have the TYPE of 1.
        setType((byte) 1);
    }

    /**
     * Creates a control message with the given float array as the values.
     *
     * @param inValues float array of values for the message.
     * @exception IllegalArgumentException if the array is too big for a message.
     */
